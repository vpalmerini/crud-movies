...
gcc client/functions/print_movie/print_movie.c -o client/functions/print_movie/print_movie.o -c
...
gcc -w wrappers/connect/connect.c -o wrappers/connect/connect.o -c
gcc -w wrappers/readline/readline.c -o wrappers/readline/readline.o -c
gcc -w client/client.c -o client/client.o -c
...
gcc -o bin/client client/client.o \
                  ...
                  client/functions/print_movie/print_movie.o \
